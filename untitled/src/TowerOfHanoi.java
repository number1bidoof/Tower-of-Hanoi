...
public class TowerOfHanoi {
    ...
    public static ArrayList getPeg(char disk){
        switch (disk) {
            case 'A':
                return pegA;
            case 'B':
    ...
    public static void printStatistics(int n) {
        ...
        if (moveCount == (int)Math.pow(2, n) - 1) {
            System.out.println("Yippeee! the solution is the most optimal");
        } else {
            System.out.println("OH NO! the solution is NOT the most optimal");
        }
    }
